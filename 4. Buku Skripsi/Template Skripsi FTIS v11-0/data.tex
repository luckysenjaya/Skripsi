...
Berdasarkan pengujian, sistem dapat mengirim email ke masing-masing pemilik \textit{task}. Email langsung dikirim setelah \textit{user task} siap untuk dikerjakan. Dengan ini dapat disimpulkan proses integrasi \textit{user task} dan sistem email dapat dilakukan.}
